...
--tạm thời chấp nhận pk là 1 cột (tương lai có thể có nhiều cột) mà giá trị 
...
--
--THỰC HÀNH 
--thiết kế Table lưu thông tin đăng kí 1 event nào đó (giống đk qua Google Form)
--thông tin cần lưu trữ: số thứ tự đăng kí, tên full name, email, ngày giờ đăng kí
--số di động...
--*Phân tích:
--ngày giờ đăng kí: ko bắt nhập, default
...
--ĐĂNG KÍ EVENT
INSERT INTO Registration VALUES(N'An',N'Nguyễn','thuan@', '090..')
--báo lỗi ko map đc các cột rõ ràng

INSERT INTO Registration VALUES(N'An',N'Nguyễn','thuan@', '090..', NULL)
SELECT * FROM Registration

INSERT INTO Registration(FirstName,Lastname,Email,Phone)
				VALUES(N'Bình',N'Lê','Bbinh@', '091x')
